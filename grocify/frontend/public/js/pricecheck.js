let products = [];
    ...
    function populateCategoryFilters() {
        ...
        categories.forEach(category => {
            ...
            <p>
                <label>
                    <input type="checkbox" class="category-checkbox" value="${category}" onclick="toggleSubFilter('${category}')">
                    <span>${category}</span>
                </label>
            </p>
            `;
    ...
    function populateFruitTypes() {
        ...
        fruitTypes.forEach(type => {
            ...
            <p>
                <label>
                    <input type="checkbox" class="fruit-type-checkbox" value="${type}">
                    <span>${type}<span>
                </label>
            </p>
            `;
    ...
    function populateMilkTypes() {
        ...
        milkTypes.forEach(type => {
            ...
            <p>
                <label>
                    <input type="checkbox" class="milk-type-checkbox" value="${type}">
                    <span>${type}</span>
                </label>
            </p>
            `;
